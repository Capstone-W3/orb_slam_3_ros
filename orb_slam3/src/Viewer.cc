...
{
    UnpackViewerParameters(parameters);
...
void Viewer::UnpackViewerParameters(ORBParameters& parameters)
{
    // 1/fps in ms
    ...
    mImageWidth = parameters.camera.imageWidth;
    mImageHeight = parameters.camera.imageHeight;
