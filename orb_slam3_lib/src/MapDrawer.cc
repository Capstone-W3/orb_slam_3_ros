...
// MapDrawer::MapDrawer(Atlas* pAtlas, ORBParameters& parameters) : mpAtlas(pAtlas)
// {

//     UnpackMapDrawerParameters(parameters);
...
// void MapDrawer::UnpackMapDrawerParameters(ORBParameters& parameters)
// {
//     mKeyFrameSize = parameters.mapDrawer.keyFrameSize;
//     mKeyFrameLineWidth = parameters.mapDrawer.keyFrameLineWidth;
//     mGraphLineWidth = parameters.mapDrawer.graphLineWidth;
//     mPointSize = parameters.mapDrawer.pointSize;
//     mCameraSize = parameters.mapDrawer.cameraSize
//     mCameraLineWidth = parameters.mapDrawer.cameraLineWidth;
// }
