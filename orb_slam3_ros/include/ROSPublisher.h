...
#ifndef ORB_SLAM3_ROSPUBLISHER_H
#define ORB_SLAM3_ROSPUBLISHER_H
...
class ROSPublisher :
    public ORB_SLAM3::IPublisherThread,
    public ORB_SLAM3::IMapPublisher,
    public ORB_SLAM3::IFrameSubscriber
{
public:

    static constexpr const char *DEFAULT_MAP_FRAME = "/orb_slam3/map";
    static constexpr const char *DEFAULT_CAMERA_FRAME = "/orb_slam3/camera";
    static constexpr const char *DEFAULT_IMAGE_TOPIC = "/orb_slam3/image";
    ...
    virtual void Update(ORB_SLAM3::Tracking*);
...
private:
    ...
    void updateOctoMap();
    void integrateMapPoints(const std::vector<ORB_SLAM3::MapPoint*> &, const octomap::point3d &, const octomap::pose6d &, octomap::OcTree &);
    ...
    void publishOctomap();
    void publishState(ORB_SLAM3::Tracking *tracking);
    void publishImage(ORB_SLAM3::Tracking *tracking);
    void publishProjectedMap();
    void publishGradientMap();
    void publishCamTrajectory();

    // ORB_SLAM3::FrameDrawer drawer_;
    ...
    ** construction relies on 'nh_'! */
    ...
    orb_slam3_ros::ORBState orb_state_;
...
#endif //ORB_SLAM3_ROSPUBLISHER_H
