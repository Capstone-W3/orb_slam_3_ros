...
sensor_msgs::PointCloud2 PublisherUtils::convertToPCL2( const std::vector<ORB_SLAM3::MapPoint*> &map_points,
...
const char* PublisherUtils::stateDescription(orb_slam3_ros::ORBState orb_state)
{
    switch (orb_state.state) {
        case orb_slam3_ros::ORBState::SYSTEM_NOT_READY: return "System not ready";
        case orb_slam3_ros::ORBState::NO_IMAGES_YET: return "No images yet";
        case orb_slam3_ros::ORBState::NOT_INITIALIZED: return "Not initialized";
        case orb_slam3_ros::ORBState::OK: return "OK";
        case orb_slam3_ros::ORBState::LOST: return "Tracking lost";
    }
...
const orb_slam3_ros::ORBState PublisherUtils::toORBStateMessage(ORB_SLAM3::Tracking::eTrackingState trackingState)
{
    orb_slam3_ros::ORBState state_msg;
    state_msg.state = orb_slam3_ros::ORBState::UNKNOWN;

    switch (trackingState) {
        case ORB_SLAM3::Tracking::SYSTEM_NOT_READY: state_msg.state = orb_slam3_ros::ORBState::SYSTEM_NOT_READY;
                                         break;
        case ORB_SLAM3::Tracking::NO_IMAGES_YET:    state_msg.state = orb_slam3_ros::ORBState::NO_IMAGES_YET;
                                         break;
        case ORB_SLAM3::Tracking::NOT_INITIALIZED:  state_msg.state = orb_slam3_ros::ORBState::NOT_INITIALIZED;
                                         break;
        case ORB_SLAM3::Tracking::OK:               state_msg.state = orb_slam3_ros::ORBState::OK;
                                         break;
        case ORB_SLAM3::Tracking::LOST:             state_msg.state = orb_slam3_ros::ORBState::LOST;
                                         break;
    }
